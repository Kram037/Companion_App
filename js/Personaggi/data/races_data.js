...
window.RACES_DATA = Object.assign(window.RACES_DATA || {}, {
  "Nano": {
    "name_en": "Dwarf",
    ...
    "skill_proficiencies": [],
    "tool_proficiencies": [
      "Strumenti da artigiano (a scelta tra: strumenti da fabbro, attrezzi da birraio, strumenti da muratore)"
    ],
  ...
  "Dragonide": {
    ...
    "subraces": [
      {
        "name": "Dragonide Nero",
        "name_en": "Black Dragonborn",
        "description": "Discendi da un drago nero. La tua arma del soffio e' una linea di 9 metri di danni da acido e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "acido"
        ...
        "traits": [
          {
            ...
            "description": "Hai discendenza draconica e sei imparentato con questa stirpe specifica. La tua arma del soffio infligge danni da acido e ottieni resistenza a quel tipo di danno.",
            "uses": null,
            "innate_spells": null
          },
          {
            ...
            "description": "Puoi usare la tua azione per esalare energia distruttiva. La tua discendenza determina forma e tipo di danno: una linea di 9 metri lunga e 1,5 metri larga. Ogni creatura nell'area deve effettuare un tiro salvezza su Destrezza (CD = 8 + il tuo modificatore di Costituzione + il tuo bonus di competenza). In caso di TS fallito subisce 2d6 danni da acido (1d6 al 1-5 livello, 2d6 al 6-10, 3d6 al 11-15, 4d6 al 16+ livello), o meta' con un TS riuscito. Devi finire un riposo breve o lungo per usare di nuovo l'arma del soffio.",
            "uses": {
              "amount": 1,
              "recharge": "short_rest"
            },
          ...
          },
          {
            ...
            "description": "Hai resistenza ai danni da acido grazie alla tua discendenza draconica.",
            "uses": null,
            "innate_spells": null
          }
        ],
      ...
      },
      {
        ...
        "name_en": "Blue Dragonborn",
        "description": "Discendi da un drago azzurro. La tua arma del soffio e' una linea di 9 metri di danni da fulmine e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "fulmine"
        ...
        "traits": [
          {
            "name": "Discendenza Draconica",
            "name_en": "Draconic Ancestry",
            "description": "Hai discendenza draconica e sei imparentato con questa stirpe specifica. La tua arma del soffio infligge danni da fulmine e ottieni resistenza a quel tipo di danno.",
            "uses": null,
            "innate_spells": null
          },
          {
            "name": "Arma del Soffio",
            "name_en": "Breath Weapon",
            "description": "Puoi usare la tua azione per esalare energia distruttiva. La tua discendenza determina forma e tipo di danno: una linea di 9 metri lunga e 1,5 metri larga. Ogni creatura nell'area deve effettuare un tiro salvezza su Destrezza (CD = 8 + il tuo modificatore di Costituzione + il tuo bonus di competenza). In caso di TS fallito subisce 2d6 danni da fulmine (1d6 al 1-5 livello, 2d6 al 6-10, 3d6 al 11-15, 4d6 al 16+ livello), o meta' con un TS riuscito. Devi finire un riposo breve o lungo per usare di nuovo l'arma del soffio.",
            "uses": {
              "amount": 1,
              "recharge": "short_rest"
            },
          ...
          },
          {
            "name": "Resistenza ai Danni",
            "name_en": "Damage Resistance",
            "description": "Hai resistenza ai danni da fulmine grazie alla tua discendenza draconica.",
            "uses": null,
            "innate_spells": null
          }
        ],
      ...
      },
      {
        ...
        "name_en": "Green Dragonborn",
        "description": "Discendi da un drago verde. La tua arma del soffio e' una cono di 4.5 metri di danni da veleno e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "veleno"
        ...
        "traits": [
          {
            "name": "Discendenza Draconica",
            "name_en": "Draconic Ancestry",
            "description": "Hai discendenza draconica e sei imparentato con questa stirpe specifica. La tua arma del soffio infligge danni da veleno e ottieni resistenza a quel tipo di danno.",
            "uses": null,
            "innate_spells": null
          },
          {
            "name": "Arma del Soffio",
            "name_en": "Breath Weapon",
            "description": "Puoi usare la tua azione per esalare energia distruttiva. La tua discendenza determina forma e tipo di danno: una cono di 4.5 metri. Ogni creatura nell'area deve effettuare un tiro salvezza su Costituzione (CD = 8 + il tuo modificatore di Costituzione + il tuo bonus di competenza). In caso di TS fallito subisce 2d6 danni da veleno (1d6 al 1-5 livello, 2d6 al 6-10, 3d6 al 11-15, 4d6 al 16+ livello), o meta' con un TS riuscito. Devi finire un riposo breve o lungo per usare di nuovo l'arma del soffio.",
            "uses": {
              "amount": 1,
              "recharge": "short_rest"
            },
          ...
          },
          {
            "name": "Resistenza ai Danni",
            "name_en": "Damage Resistance",
            "description": "Hai resistenza ai danni da veleno grazie alla tua discendenza draconica.",
            "uses": null,
            "innate_spells": null
          }
        ],
      ...
      },
      {
        ...
        "name_en": "Red Dragonborn",
        "description": "Discendi da un drago rosso. La tua arma del soffio e' una cono di 4.5 metri di danni da fuoco e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "fuoco"
        ...
        "traits": [
          {
            "name": "Discendenza Draconica",
            "name_en": "Draconic Ancestry",
            "description": "Hai discendenza draconica e sei imparentato con questa stirpe specifica. La tua arma del soffio infligge danni da fuoco e ottieni resistenza a quel tipo di danno.",
            "uses": null,
            "innate_spells": null
          },
          {
            "name": "Arma del Soffio",
            "name_en": "Breath Weapon",
            "description": "Puoi usare la tua azione per esalare energia distruttiva. La tua discendenza determina forma e tipo di danno: una cono di 4.5 metri. Ogni creatura nell'area deve effettuare un tiro salvezza su Destrezza (CD = 8 + il tuo modificatore di Costituzione + il tuo bonus di competenza). In caso di TS fallito subisce 2d6 danni da fuoco (1d6 al 1-5 livello, 2d6 al 6-10, 3d6 al 11-15, 4d6 al 16+ livello), o meta' con un TS riuscito. Devi finire un riposo breve o lungo per usare di nuovo l'arma del soffio.",
            "uses": {
              "amount": 1,
              "recharge": "short_rest"
            },
          ...
          },
          {
            "name": "Resistenza ai Danni",
            "name_en": "Damage Resistance",
            "description": "Hai resistenza ai danni da fuoco grazie alla tua discendenza draconica.",
            "uses": null,
            "innate_spells": null
          }
        ],
      ...
      },
      {
        ...
        "name_en": "White Dragonborn",
        "description": "Discendi da un drago bianco. La tua arma del soffio e' una cono di 4.5 metri di danni da freddo e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "freddo"
        ...
        "traits": [
          {
            "name": "Discendenza Draconica",
            "name_en": "Draconic Ancestry",
            "description": "Hai discendenza draconica e sei imparentato con questa stirpe specifica. La tua arma del soffio infligge danni da freddo e ottieni resistenza a quel tipo di danno.",
            "uses": null,
            "innate_spells": null
          },
          {
            "name": "Arma del Soffio",
            "name_en": "Breath Weapon",
            "description": "Puoi usare la tua azione per esalare energia distruttiva. La tua discendenza determina forma e tipo di danno: una cono di 4.5 metri. Ogni creatura nell'area deve effettuare un tiro salvezza su Costituzione (CD = 8 + il tuo modificatore di Costituzione + il tuo bonus di competenza). In caso di TS fallito subisce 2d6 danni da freddo (1d6 al 1-5 livello, 2d6 al 6-10, 3d6 al 11-15, 4d6 al 16+ livello), o meta' con un TS riuscito. Devi finire un riposo breve o lungo per usare di nuovo l'arma del soffio.",
            "uses": {
              "amount": 1,
              "recharge": "short_rest"
            },
          ...
          },
          {
            "name": "Resistenza ai Danni",
            "name_en": "Damage Resistance",
            "description": "Hai resistenza ai danni da freddo grazie alla tua discendenza draconica.",
            "uses": null,
            "innate_spells": null
          }
        ],
      ...
      },
      {
        ...
        "name_en": "Brass Dragonborn",
        "description": "Discendi da un drago d'ottone. La tua arma del soffio e' una linea di 9 metri di danni da fuoco e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "fuoco"
      ...
      },
      {
        ...
        "name_en": "Bronze Dragonborn",
        "description": "Discendi da un drago di bronzo. La tua arma del soffio e' una linea di 9 metri di danni da fulmine e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "fulmine"
      ...
      },
      {
        ...
        "name_en": "Copper Dragonborn",
        "description": "Discendi da un drago di rame. La tua arma del soffio e' una linea di 9 metri di danni da acido e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "acido"
      ...
      },
      {
        ...
        "name_en": "Gold Dragonborn",
        "description": "Discendi da un drago d'oro. La tua arma del soffio e' una cono di 4.5 metri di danni da fuoco e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "fuoco"
      ...
      },
      {
        ...
        "name_en": "Silver Dragonborn",
        "description": "Discendi da un drago d'argento. La tua arma del soffio e' una cono di 4.5 metri di danni da freddo e hai resistenza a quel tipo di danno.",
        "ability_score_increase": {},
        "asi_text": "",
        "resistances": [
          "freddo"
  ...
  "Tiefling": {
    ...
    "subraces": [
        ...
        "traits": [
          {
            ...
            "description": "Conosci il trucchetto taumaturgia. Al 3 livello puoi lanciare rimprovero infernale come incantesimo di 2 livello (1/r. lungo). Al 5 livello puoi lanciare oscurita' (1/r. lungo). Il Carisma e' la tua caratteristica da incantatore.",
            "innate_spells": [
              {
                "name_en": "Thaumaturgy",
                "name": "Taumaturgia",
      ...
      },
      {
        ...
        "name_en": "Bloodline of Baalzebul",
        "source_short": "MToF",
        "description": "Stirpe MToF: conosci il trucchetto taumaturgia; al 3 livello puoi lanciare raggio indebolente (1/riposo lungo); al 5 livello puoi lanciare corona della follia (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
        "ability_score_increase": {},
        "asi_text": "",
        "traits": [
          {
            "name": "Eredita' Baalzebul",
            "name_en": "Legacy of Baalzebul",
            "description": "Stirpe MToF: conosci il trucchetto taumaturgia; al 3 livello puoi lanciare raggio indebolente (1/riposo lungo); al 5 livello puoi lanciare corona della follia (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
            "innate_spells": [
              {
                "name_en": "Thaumaturgy",
              ...
              {
                "name_en": "Crown of Madness",
                "name": "Corona della Follia",
                "level": 2,
                "level_cast": 2,
                "min_pg_level": 5,
                "recharge": "long_rest",
      ...
      },
      {
        ...
        "name_en": "Bloodline of Dispater",
        "source_short": "MToF",
        "description": "Stirpe MToF: conosci il trucchetto taumaturgia; al 3 livello puoi lanciare camuffare sé stesso (1/riposo lungo); al 5 livello puoi lanciare individuazione del pensiero (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
        "ability_score_increase": {},
        "asi_text": "",
        "traits": [
          {
            "name": "Eredita' Dispater",
            "name_en": "Legacy of Dispater",
            "description": "Stirpe MToF: conosci il trucchetto taumaturgia; al 3 livello puoi lanciare camuffare sé stesso (1/riposo lungo); al 5 livello puoi lanciare individuazione del pensiero (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
            "innate_spells": [
              {
                "name_en": "Thaumaturgy",
      ...
      },
      {
        ...
        "name_en": "Bloodline of Fierna",
        "source_short": "MToF",
        "description": "Stirpe MToF: conosci il trucchetto amicizia; al 3 livello puoi lanciare charme su persone (1/riposo lungo); al 5 livello puoi lanciare suggestione (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
        "ability_score_increase": {},
        "asi_text": "",
        "traits": [
          {
            "name": "Eredita' Fierna",
            "name_en": "Legacy of Fierna",
            "description": "Stirpe MToF: conosci il trucchetto amicizia; al 3 livello puoi lanciare charme su persone (1/riposo lungo); al 5 livello puoi lanciare suggestione (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
            "innate_spells": [
              {
                "name_en": "Friends",
      ...
      },
      {
        ...
        "name_en": "Bloodline of Glasya",
        "source_short": "MToF",
        "description": "Stirpe MToF: conosci il trucchetto illusione minore; al 3 livello puoi lanciare camuffare sé stesso (1/riposo lungo); al 5 livello puoi lanciare invisibilità (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
        "ability_score_increase": {},
        "asi_text": "",
        "traits": [
          {
            "name": "Eredita' Glasya",
            "name_en": "Legacy of Glasya",
            "description": "Stirpe MToF: conosci il trucchetto illusione minore; al 3 livello puoi lanciare camuffare sé stesso (1/riposo lungo); al 5 livello puoi lanciare invisibilità (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
            "innate_spells": [
              {
                "name_en": "Minor Illusion",
      ...
      },
      {
        ...
        "name_en": "Bloodline of Levistus",
        "source_short": "MToF",
        "description": "Stirpe MToF: conosci il trucchetto raggio di gelo; al 3 livello puoi lanciare armatura di agathys (1/riposo lungo); al 5 livello puoi lanciare oscurità (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
        "ability_score_increase": {},
        "asi_text": "",
        "traits": [
          {
            "name": "Eredita' Levistus",
            "name_en": "Legacy of Levistus",
            "description": "Stirpe MToF: conosci il trucchetto raggio di gelo; al 3 livello puoi lanciare armatura di agathys (1/riposo lungo); al 5 livello puoi lanciare oscurità (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
            "innate_spells": [
              {
      ...
      },
      {
        ...
        "name_en": "Bloodline of Mammon",
        "source_short": "MToF",
        "description": "Stirpe MToF: conosci il trucchetto mano magica; al 3 livello puoi lanciare disco fluttuante di tenser (1/riposo lungo); al 5 livello puoi lanciare chiusura arcana (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
        "ability_score_increase": {},
        "asi_text": "",
        "traits": [
          {
            "name": "Eredita' Mammon",
            "name_en": "Legacy of Mammon",
            "description": "Stirpe MToF: conosci il trucchetto mano magica; al 3 livello puoi lanciare disco fluttuante di tenser (1/riposo lungo); al 5 livello puoi lanciare chiusura arcana (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
            "innate_spells": [
              {
                "name_en": "Mage Hand",
      ...
      },
      {
        ...
        "name_en": "Bloodline of Mephistopheles",
        "source_short": "MToF",
        "description": "Stirpe MToF: conosci il trucchetto mano magica; al 3 livello puoi lanciare mani brucianti (1/riposo lungo); al 5 livello puoi lanciare lama infuocata (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
        "ability_score_increase": {},
        "asi_text": "",
        "traits": [
          {
            "name": "Eredita' Mefistofele",
            "name_en": "Legacy of Mephistopheles",
            "description": "Stirpe MToF: conosci il trucchetto mano magica; al 3 livello puoi lanciare mani brucianti (1/riposo lungo); al 5 livello puoi lanciare lama infuocata (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
            "innate_spells": [
              {
                "name_en": "Mage Hand",
      ...
      },
      {
        ...
        "name_en": "Bloodline of Zariel",
        "source_short": "MToF",
        "description": "Stirpe MToF: conosci il trucchetto taumaturgia; al 3 livello puoi lanciare castigo bruciante (1/riposo lungo); al 5 livello puoi lanciare castigo marchiante (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
        "ability_score_increase": {},
        "asi_text": "",
        "traits": [
          {
            "name": "Eredita' Zariel",
            "name_en": "Legacy of Zariel",
            "description": "Stirpe MToF: conosci il trucchetto taumaturgia; al 3 livello puoi lanciare castigo bruciante (1/riposo lungo); al 5 livello puoi lanciare castigo marchiante (1/riposo lungo). Il Carisma e' la tua caratteristica da incantatore.",
            "innate_spells": [
              {
                "name_en": "Thaumaturgy",
              ...
              {
                "name_en": "Branding Smite",
                "name": "Castigo Marchiante",
                "level": 2,
                "level_cast": 2,
                "min_pg_level": 5,
                "recharge": "long_rest",
    ...
    "subraces": [
      {
        ...
        "source": "Volo's Guide to Monsters",
        "base_race_name": "Aasimar",
        "base_race_name_en": "Aasimar",
        "version_source": "VGtM",
        "version_id": "aasimar-protector-aasimar-vgtm",
        "version_label": "Aasimar Protettore (VGtM)",
        "version_group": "aasimar-protector-aasimar"
      },
      {
        ...
        "base_race_name_en": "Aasimar",
        "version_source": "VGtM",
        "version_id": "aasimar-scourge-aasimar-vgtm",
        "version_label": "Aasimar Sferzante (VGtM)",
        "version_group": "aasimar-scourge-aasimar"
      },
      {
        "name": "Aasimar Caduto",
        ...
        "base_race_name_en": "Aasimar",
        "version_source": "VGtM",
        "version_id": "aasimar-fallen-aasimar-vgtm",
        "version_label": "Aasimar Caduto (VGtM)",
        "version_group": "aasimar-fallen-aasimar"
      }
    ],
    "version_source": "VGtM",
    "version_id": "aasimar-vgtm",
    "version_label": "Aasimar (VGtM)",
  ...
  "Aasimar": {
    ...
    "traits": [
      ...
      },
      {
        "name": "Mani Curatrici",
        "name_en": "Healing Hands",
        "description": "Come azione, puoi toccare una creatura e tirare un numero di d4 pari al tuo bonus di competenza. La creatura recupera un numero di punti ferita pari al totale ottenuto. Una volta usata questa abilita', non puoi usarla di nuovo finche' non termini un riposo lungo.",
        "uses": {
          "amount": 1,
          "recharge": "long_rest"
        },
