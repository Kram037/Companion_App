...
- [x] Garantire compatibilita' service worker/PWA:
  - [x] asset versionati;
  - [x] cache dei runtime data bundle;
  - [x] nessun reload automatico durante uso attivo.
...
- [x] Sostituire gradualmente `sessionStorage currentPage/currentCampagnaId/currentSessioneId` con URL params.
