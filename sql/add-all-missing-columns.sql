...
ALTER TABLE personaggi ADD COLUMN IF NOT EXISTS privilegi JSONB DEFAULT '{}';
ALTER TABLE personaggi ADD COLUMN IF NOT EXISTS stile_combattimento JSONB DEFAULT '{}';
